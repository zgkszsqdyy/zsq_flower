...
public class SelectProductListServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp)
		...
		if(name1!=null){
			list = EASYBUY_PRODUCTDao.selectAllByName(cpage, count,name1);
			tpage = EASYBUY_PRODUCTDao.totalPageByName(count, name1);
			req.setAttribute("name1",name1);
			//System.out.println(name1);
			req.setAttribute("title", "搜索商品："+name1);
		} 
		...
		//搜索关键字
		req.setAttribute("search_words", name1);
		//父分类
