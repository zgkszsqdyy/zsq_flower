...
function checkusername(){
	...
	if(username==""){
		document.getElementById("sp").innerHTML="<font color='red'>&nbsp用户名不能为空</font>";
...
function checkname(){
	...
	if(name1==""){
		document.getElementById("sn").innerHTML="<font color='red'>&nbsp姓名不能为空</font>";
		document.getElementById("sb").disabled=true;
	}else{
...
function checkpwd(){
	...
	if(passWord==""){
		document.getElementById("spwd").innerHTML="<font color='red'>&nbsp密码不能为空</font>";
		document.getElementById("sb").disabled=true;
	}else{
...
function checkbirthday(){
	...
	if(birthday==""){
		document.getElementById("sbb").innerHTML="<font color='red'>&nbsp生日不能为空</font>";
		document.getElementById("sb").disabled=true;
	}else{
