...
<head>
	...
	<script type="text/javascript">
		function check() {
			...
			if(num<0){
				document.getElementById("yy").innerHTML="<font color='red'>&nbsp价格不能为负数</font>";
		...
		function check2() {
			...
			if(num<0){
				document.getElementById("kk").innerHTML="<font color='red'>&nbsp库存不能为负数</font>";
				document.getElementById("sub").disabled=true;
			}else{
...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">千衣千寻-商城</a> &gt; 管理后台
</div>
			...
			<form action="doProductAdd" method="post" enctype="multipart/form-data">
				<table class="form">
					...
					<tr>
						...
						<td><input type="text" class="text tiny" name="productPrice" value="" onblur="check()" id="y"/> 元<span id="yy"></span></td>
					</tr>
					<tr>
						<td class="field">描述：</td>
						<td><input type="text" class="text" name="productDesc" value=""/></td>
					</tr>
					<tr>
						<td class="field">库存：</td>
						<td><input type="text" class="text tiny" name="productStock" value="" onblur="check2()" id="k"/><span id="kk"></span></td>
					</tr>
					<tr>
						<td></td>
						<td><label class="ui-blue"><input type="submit" name="submit" value="添加" id="sub"/></label></td>
					</tr>
				</table>
			</form>
		</div>
