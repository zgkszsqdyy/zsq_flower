...
<script type="text/javascript">
  function jump(p,fid){
	  location.href='selectProductList?cp='+p+'&fid='+fid;
  }
  function jump1(p,cid){
	  location.href='selectProductList?cp='+p+'&cid='+cid;
  }
  function jump2(p,name1){
	  location.href='selectProductList?cp='+p+'&name1='+name1;
  }
  function jump3(p){
  ...
  <script type="text/javascript">
function selectname(){
	  var name1 = document.getElementById("selectname").value;
	  location.href='selectProductList?name1='+name1;
}
function searchHot(name1){
	location.href='selectProductList?name1='+name1;
}
...
<div id="position" class="wrap">
	您现在的位置：<a href="indexSelect">千衣千寻-商城</a> &gt; <a href="selectProductList">商品分类</a> &gt; ${title }
</div>
<div id="main" class="wrap">
	...
	<c:if test="${requestScope.fid != null}">
			<div class="main">
				<div class="product-list">
					...
					<div class="pager">
						<ul class="clearfix">
							...
							<li><a href="selectProductList?cp=1&fid=${requestScope.fid}">首页</a></li>
							<li><a href="selectProductList?cp=${cpage-1<=0 ? 1 : cpage-1 }&fid=${requestScope.fid}">上一页</a></li>
							<li><a href="selectProductList?cp=${cpage+1>=tpage ? tpage : cpage+1 }&fid=${requestScope.fid}">下一页</a></li>
							<li><a href="selectProductList?cp=${tpage }&fid=${requestScope.fid}">尾页</a></li>
							<li><select onchange="jump(this.value,${requestScope.fid})">
		...
		<div class="main">
			<div class="product-list">
				...
				<div class="pager">
					<ul class="clearfix">
						<li>当前:${cpage}/${tpage }页</li>
						<li><a href="selectProductList?cp=1&cid=${requestScope.cid}">首页</a></li>
						<li><a href="selectProductList?cp=${cpage-1<=0 ? 1 : cpage-1 }&cid=${requestScope.cid}">上一页</a></li>
						<li><a href="selectProductList?cp=${cpage+1>=tpage ? tpage : cpage+1 }&cid=${requestScope.cid}">下一页</a></li>
						<li><a href="selectProductList?cp=${tpage }&cid=${requestScope.cid}">尾页</a></li>
						<li><select onchange="jump1(this.value,${requestScope.cid})">
							<c:forEach var="i" begin="1" end="${tpage}">
								<option ${i==cpage ? "selected" : "" } value="${i}">${i }页</option>
							</c:forEach>
						</select></li>
...
<c:if test="${requestScope.name1 != null}">
	<div class="main">
		<div class="product-list">
			<h2>${title }</h2>
			<div class="pager">
				<ul class="clearfix">
					<li>当前:${cpage}/${tpage }页</li>
					<li><a href="selectProductList?cp=1&name1=${requestScope.name1}">首页</a></li>
					<li><a href="selectProductList?cp=${cpage-1<=0 ? 1 : cpage-1 }&name1=${requestScope.name1}">上一页</a></li>
					<li><a href="selectProductList?cp=${cpage+1>=tpage ? tpage : cpage+1 }&name1=${requestScope.name1}">下一页</a></li>
					<li><a href="selectProductList?cp=${tpage }&name1=${requestScope.name1}">尾页</a></li>
					<li><select onchange="jump2(this.value,'${requestScope.name1}')">
						<c:forEach var="i" begin="1" end="${tpage}">
							<option ${i==cpage ? "selected" : "" } value="${i}">${i }页</option>
						</c:forEach>
					</select></li>
...
<c:if test="${requestScope.name1 == null && requestScope.fid == null && requestScope.cid == null}">
	<div class="main">
		<div class="product-list">
			<h2>${title }</h2>
			<div class="pager">
				<ul class="clearfix">
					...
					<li><select onchange="jump3(this.value)">
						<c:forEach var="i" begin="1" end="${tpage}">
							<option ${i==cpage ? "selected" : "" } value="${i}">${i }页</option>
						</c:forEach>
					</select></li>
