...
<div id="position" class="wrap">
	您现在的位置：<a href="${pageContext.request.contextPath}/indexSelect">千衣千寻-商城</a> &gt; 购物车
</div>
<div class="wrap">
	<div id="shopping">
		<form action="gmServlet">
			<table>
				...
				<c:forEach var="rs" items="${requestScope.shoplist}">
					...
					<tr id="product_id_1">
						<td class="thumb"><input type="checkbox" name="op" onclick="dxcheck()" value="${rs.es_id}" data-valuetwo="${rs.es_id}"/><img src="images/product/${rs.es_ep_file_name }" height="100" width="100" />
